...
keys.set(3675, { name: 'LEFT_META', char: '' })
keys.set(3676, { name: 'RIGHT_META', char: '' })
keys.set(3640, { name: 'RIGHT_ALT', char: '' })
keys.set(57416, { name: 'TOP', char: '' })
keys.set(57424, { name: 'BOTTOM', char: '' })
keys.set(57419, { name: 'LEFT', char: '' })
keys.set(57421, { name: 'RIGHT', char: '' })

function listAllKnownKeys() {
  return Array.from(keys.entries()).map(entry => ({
    code: entry[0],
    ...entry[1]
  }))
}
